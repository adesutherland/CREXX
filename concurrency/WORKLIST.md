...
| CONC-11 | solution-point QA, portable conformance and initial publication | active | initial publication and four-platform Actions/CodeQL pass; QA-A, Mac QA-B and three-compiler Windows QA-D pass; unchanged Mac AC replay waived | complete formal Linux QA-C in `QA-CLOSEOUT.md` |
