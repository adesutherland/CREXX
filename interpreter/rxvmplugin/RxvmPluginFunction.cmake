...
function(configure_linker_for_static_rxvmplugin target pluginId)
    if(MSVC)
        ...
        target_link_libraries(${target} "${CMAKE_BINARY_DIR}/bin/rxvm_${pluginId}.lib")
        set_target_properties(${target} PROPERTIES LINK_FLAGS "/INCLUDE:${pluginId}_register_rxvm_plugin")
    elseif(CMAKE_COMPILER_IS_GNUCC OR CMAKE_COMPILER_IS_GNUCXX)
        # For GCC
        target_link_libraries(${target} "-Wl,--whole-archive \"${CMAKE_BINARY_DIR}/bin/rxvm_${pluginId}.a\" -Wl,--no-whole-archive")
    elseif(CMAKE_C_COMPILER_ID MATCHES "Clang")
        # For Clang
        target_link_libraries(${target} "-Wl,-force_load,\"${CMAKE_BINARY_DIR}/bin/rxvm_${pluginId}.a\"")
    endif()
endfunction()
