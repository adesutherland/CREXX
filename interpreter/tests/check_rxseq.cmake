...
elseif(LENGTH EQUAL 3)
    set(EXPECTED "5,1,1,4,candidate,\"IADD_REG_REG_INT\\(r1,r1,c1\\) \\| COPY_REG_REG\\(r2,r1\\) \\| COPY_REG_REG\\(r3,r2\\)\"")
else()
    set(EXPECTED "5,1,1,6,candidate,\"IADD_REG_REG_INT\\(r1,r1,c1\\) \\| COPY_REG_REG\\(r2,r1\\) \\| COPY_REG_REG\\(r3,r2\\) \\| BLT_ID_REG_REG\\(c2,r1,r4\\)\"")
endif()
if(NOT CONTENT MATCHES "${EXPECTED}")
    message(FATAL_ERROR "expected dynamic count/mapping was not found in:\n${CONTENT}")
endif()
if(LENGTH EQUAL 2 AND NOT CONTENT MATCHES
        "CNOP_REG_REG_REG_REG_REG_REG_REG_REG_REG\\(r1,r2,r3,r4,r5,r6,r7,r8,r9\\)")
    message(FATAL_ERROR "wide-operand candidate was not found in:\n${CONTENT}")
endif()
