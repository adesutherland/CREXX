...
\newfontfamily\headingfont{Avenir Light}
...
\titleformat{\part}[display]
  ...
  {%
    ...
    \begin{minipage}[b]{0.65\textwidth}
      {\fontspec{Avenir Light}\fontsize{16}{20}\selectfont\color{gray}PART \thepart}\\[1.5em]
      {\fontspec{Avenir Light}\fontsize{34}{38}\selectfont\bfseries #1}
    \end{minipage}%
  }
