...
main() .locals=1 .expose=hello.main
   ...
   .srcstep 1 1 17 "hello" 3 1 25 "say 'hello cRexx world!'"
   say "hello cRexx world!"
   .srcstep 2 2 17 "hello" 4 1 8 "return 0"
   ret 0
\end{verbatim}
...
address system 'gcc -O3 -DNDEBUG -o ' || execName || ' -L "' || crexx_home || '" -lrxvml -lrxpashim -lrxvmplugin -lrxvmref -lplatform -ldecnumber -lavl_tree -lrxpa -lm' || socketLib || ' "' || crexx_home || '/rxvm_mc_decimal_manual.a" ' || execName || '.c'
if rc<>0 then exit rc
\end{verbatim}
