...
address system 'gcc -O3 -DNDEBUG -o ' || execName || ' -L "' || crexx_home || '" -lrxvml -lrxpashim -lrxvmplugin -lplatform -ldecnumber -lavl_tree -lrxpa -lm' || socketLib || ' "' || crexx_home || '/rxvm_mc_decimal_manual.a" ' || execName || '.c'
if rc<>0 then exit rc
\end{verbatim}
