...
% Use a combination of the open source IBM Plex and TeX Gyre font families.

% \setmainfont{IBMPlexSerif-Regular.otf}[
\setmainfont{TeX Gyre Pagella}
[
  BoldFont = IBMPlexSerifBold,
  ItalicFont = IBMPlexSerifItalic,
  BoldItalicFont = IBMPlexSerifBoldItalic]
...
\tikzset{memory layout/.style={fill=gray!10,draw}}
...
\newcommand{\myTitle}{\fontspec[Scale=1.4]{TeX Gyre Termes}\crexx{} Principles of Operation}

\begin{DIFnomarkup}
\title{\myTitle}\fontspec{TeX Gyre Pagella}
...
\input{../Logical-Grammar-Specification.tex}
...
\input{../Building_and_Running_cRexx}
