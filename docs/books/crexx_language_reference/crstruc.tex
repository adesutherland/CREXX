\chapter{General Syntax}\label{refclau}
\index{Clauses,}
\index{Semicolons,}
\index{,}
...
associated with the options \code{options comments_hash (default) / comments_nohash}.
...
This is associated with the options \code{Options comments_slash  / comments_noslash (default)}.
%     Dash '--' line comments. Options comments_dash  / comments_nodash (default)
%     Slash '//' line comments. Options comments_slash  / comments_noslash (default)
%     Hash '#' line comments. Options comments_hash (default) / comments_nohash
...
This is associated with the options \code{Options comments_dash  / noscomments_dash (default)}.
...
\index{Comma,as continuation character}
\index{, continuation character,}
...
\item The last token was a comma.
In this case the comma (',') is functionally replaced by a blank, and hence
