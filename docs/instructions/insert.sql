...
insert into instruction VALUES('0x0004' ,'metaloadedmodules' ,' {REG}        ','        Loaded Modules (op1 = array loaded modules)','7');
...
insert into instruction VALUES('0x0007' ,'metadecodeinst' ,' {REG,REG}       ','     Decode opcode (op1 decoded op2)','7');
insert into instruction VALUES('0x000e' ,'metaloadcalleraddr' ,' {REG}       ','         Load caller address object to op1','7');
insert into instruction VALUES('0x000c' ,'metaloaddata' ,' {REG,REG,REG}     ','   Load Metadata (op1 = (metadata)op2[op3])','7');
insert into instruction VALUES('0x0005' ,'metaloadedprocs' ,' {REG,REG}      ','      Loaded Procedures (op1 = array procedures in module op2)','7');
insert into instruction VALUES('0x0009' ,'metaloadfoperand' ,' {REG,REG,REG} ','       Load Float Operand (op1 = (float)op2[op3])','7');
insert into instruction VALUES('0x0006' ,'metaloadinst' ,' {REG,REG,REG}     ','   Load Instruction Code (op1 = (inst)op2[op3])','7');
insert into instruction VALUES('0x0008' ,'metaloadioperand' ,' {REG,REG,REG} ','       Load Integer/Index Operand (op1 = (int)op2[op3])','7');
insert into instruction VALUES('0x0003' ,'metaloadmodule' ,' {REG,REG}       ','     Load Module (op1 = module num of last loaded module in rx','7');
insert into instruction VALUES('0x000b' ,'metaloadpoperand' ,' {REG,REG,REG} ','       Load Procedure Operand (op1 = (proc)op2[op3])','7');
insert into instruction VALUES('0x000a' ,'metaloadsoperand' ,' {REG,REG,REG} ','       Load String Operand (op1 = (string)op2[op3])','7');
...
insert into instruction VALUES('0x000d' ,'metalinkpreg' ,' {REG,REG}         ','   Link parent-frame-register[op2] to op1','7');
