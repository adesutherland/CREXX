% \chapter{Methods for \crexx{} strings}\label{refbmeth}
...
% \begin{enumerate}
% \item All methods work on a \crexx{} string of type \textbf{R\textsc{exx}}; this
...
% \end{enumerate}
% \subsection{The built-in methods}\label{builtinmethods}
\begin{description}
