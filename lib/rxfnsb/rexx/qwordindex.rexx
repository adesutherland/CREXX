...
namespace rxfnsb expose qwordindex
 ...
 /* ------------------------------------------------------------------
  * QWORDINDEX(line, wanted)
  *
  *   Returns position of the Nth word from 'line', keeping quoted strings intact.
  *
 ...
 qwordindex: procedure = .int
   ...
   if n1 + n2 = 0 then return wordIndex(line, wanted)
   ...
   do while pos < len
      ...
      if ch = 34 | ch = 39 then do                    /* if it’s a quote: " or ' */
         ...
         wordno = wordno + 1
         if wordno = wanted then return i
 ...
 return 0                                         /* wanted word not found */