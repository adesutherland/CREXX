...
generate ObjectEquatable.crexx                              >> "$output"
generate ObjectKeyStrategy.crexx                            >> "$output"
generate ObjectObjectHashMap.crexx                          >> "$output"
generate ObjectObjectHashMapIterator.crexx                  >> "$output"
