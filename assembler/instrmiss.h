/* ------------------------------------------------------------------------------------
 *  SCONCAT_REG_REG_REG  String Concat (op1=op2||op3)              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  SCONCAT_REG_REG_STRING  String Concat (op1=op2||op3)              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  SCONCAT_REG_STRING_REG  String Concat (op1=op2||op3)              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  CONCATS_REG_REG_REG  Convert and Concat to String (op1=op2||op3)              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  CONCATS_REG_REG_STRING  Convert and Concat to String (op1=op2||op3)              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  CONCATS_REG_STRING_REG  Convert and Concat to String (op1=op2||op3)              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  STRLEN_REG_REG  String Length op1 = length(op2)              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  STR2CHAR_REG_REG_REG  String to Char op1 = op2[op3]              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  IPRIME_REG  Int Prime op1              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  FPRIME_REG  Float Prime op1              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  SPRIME_REG  String Prime op1              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  CPRIME_REG  Char Prime op1              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  MAP_REG_REG  Map op1 to var name in op2              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  MAP_REG_STRING  Map op1 to var name op2              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  PMAP_REG_REG  Map op1 to parent var name in op2              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  PMAP_REG_STRING  Map op1 to parent var name op2              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  GMAP_REG_REG  Map op1 to global var name in op2              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  GMAP_REG_STRING  Map op1 to global var name op2              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  NSMAP_REG_REG_REG  Map op1 to namespace in op2 var name in op3              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  NSMAP_REG_REG_STRING  Map op1 to namespace in op2 var name op3              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  NSMAP_REG_STRING_STRING  Map op1 to namespace op2 var name op3              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  NSMAP_REG_STRING_REG  Map op1 to namespace op2 var name in op3              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  UNMAP_REG  Unmap op1              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  RET_CHAR  Return op1              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  LINK_REG_REG  Link op2 to op1              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  UNLINK_REG  Unlink op1              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  NULL_REG  Null op1              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  LOAD_REG_CHAR  Load op1 with op2              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  EXIT_REG  Exit op1              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
...
/* ------------------------------------------------------------------------------------
 *  EXIT_INT  Exit op1              pej 14 Apr 2021
 *  -----------------------------------------------------------------------------------
 */
