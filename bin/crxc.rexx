...
'gcc -o' execName '-lrxvml -lmachine -lavl_tree -lplatform -lm -L'crexx_home'/interpreter -L'crexx_home'/machine -L'crexx_home'/avl_tree -L'crexx_home'/platform'  execName'.c'
