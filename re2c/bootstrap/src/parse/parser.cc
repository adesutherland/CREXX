...
#line 1 "../../crexx-develop/re2c/src/parse/parser.ypp"
...
static const yytype_uint8 yyprhs[] =
{
      ...
      27,    30,    32,    34,    36,    39,    42,    45,    49,    53,
      57,    60,    63,    65,    68,    70,    72,    76,    78,    82,
      84,    88,    90,    93,    95,    98,   101,   103,   106,   108,
     110,   112,   114,   116
};
...
{
      29,     0,    -1,    -1,    29,    16,    -1,    29,    10,    -1,
      29,    30,    -1,    29,    33,    -1,    29,    14,    -1,    31,
      36,    32,    -1,    31,    36,    17,    -1,    11,    18,    -1,
      12,    -1,    19,    -1,    13,    -1,    35,     9,    -1,    20,
       9,    -1,    21,     9,    -1,     5,    35,    34,    -1,     5,
      20,    34,    -1,     5,    21,    34,    -1,     6,     9,    -1,
       7,    34,    -1,     9,    -1,     4,     9,    -1,     3,    -1,
      36,    -1,    36,    17,    36,    -1,    37,    -1,    36,    22,
      37,    -1,    38,    -1,    37,    23,    38,    -1,    39,    -1,
      39,    38,    -1,    42,    -1,    42,    40,    -1,    42,     8,
      -1,    41,    -1,    40,    41,    -1,    20,    -1,    24,    -1,
      25,    -1,    15,    -1,    11,    -1,    26,    36,    27,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,    66,    66,    68,    72,    75,    76,    77,    81,    90,
...
static const char *const yytname[] =
{
  ...
  "TOKEN_LINE_INFO", "TOKEN_REGEXP", "TOKEN_BLOCK", "'/'", "'='", "';'",
  "'*'", "'$'", "'|'", "'\\\\'", "'+'", "'?'", "'('", "')'", "$accept",
  "spec", "def", "name", "enddef", "rule", "ccode", "trailexpr", "expr",
  "diff", "term", "factor", "closes", "close", "primary", 0
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 3:
#line 68 "../../crexx-develop/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 4:
#line 72 "../../crexx-develop/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 8:
#line 81 "../../crexx-develop/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 9:
#line 90 "../../crexx-develop/re2c/src/parse/parser.ypp"
    {
    context.input.msg.error(context.input.tok_loc()
...
;}
  ...
  case 10:
#line 97 "../../crexx-develop/re2c/src/parse/parser.ypp"
    { (yyval.str) = (yyvsp[(1) - (2)].str); ;}
    break;

  case 14:
#line 104 "../../crexx-develop/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 15:
#line 107 "../../crexx-develop/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 16:
#line 110 "../../crexx-develop/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 17:
#line 113 "../../crexx-develop/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 18:
#line 119 "../../crexx-develop/re2c/src/parse/parser.ypp"
    {
    for(CondList::const_iterator i = (yyvsp[(1) - (3)].clist)->begin(); i != (yyvsp[(1) - (3)].clist)->end(); ++i) {
...
;}
  ...
  case 19:
#line 125 "../../crexx-develop/re2c/src/parse/parser.ypp"
    {
    for(CondList::const_iterator i = (yyvsp[(1) - (3)].clist)->begin(); i != (yyvsp[(1) - (3)].clist)->end(); ++i) {
...
;}
  ...
  case 20:
#line 131 "../../crexx-develop/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 21:
#line 137 "../../crexx-develop/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 23:
#line 145 "../../crexx-develop/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 24:
#line 150 "../../crexx-develop/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 25:
#line 157 "../../crexx-develop/re2c/src/parse/parser.ypp"
    { (yyval.regexp) = ast_cap((yyvsp[(1) - (1)].regexp)); ;}
    break;

  case 26:
#line 158 "../../crexx-develop/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 28:
#line 165 "../../crexx-develop/re2c/src/parse/parser.ypp"
    { (yyval.regexp) = ast_alt((yyvsp[(1) - (3)].regexp), (yyvsp[(3) - (3)].regexp)); ;}
    break;

  case 30:
#line 170 "../../crexx-develop/re2c/src/parse/parser.ypp"
    { (yyval.regexp) = ast_diff((yyvsp[(1) - (3)].regexp), (yyvsp[(3) - (3)].regexp)); ;}
    break;

  case 32:
#line 176 "../../crexx-develop/re2c/src/parse/parser.ypp"
    { (yyval.regexp) = ast_cat((yyvsp[(1) - (2)].regexp), (yyvsp[(2) - (2)].regexp)); ;}
    break;

  case 34:
#line 181 "../../crexx-develop/re2c/src/parse/parser.ypp"
    {
    switch((yyvsp[(2) - (2)].op)) {
...
;}
  ...
  case 35:
#line 188 "../../crexx-develop/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 37:
#line 195 "../../crexx-develop/re2c/src/parse/parser.ypp"
    { (yyval.op) = ((yyvsp[(1) - (2)].op) == (yyvsp[(2) - (2)].op)) ? (yyvsp[(1) - (2)].op) : '*'; ;}
    break;

  case 38:
#line 199 "../../crexx-develop/re2c/src/parse/parser.ypp"
    { (yyval.op) = '*'; ;}
    break;

  case 39:
#line 200 "../../crexx-develop/re2c/src/parse/parser.ypp"
    { (yyval.op) = '+'; ;}
    break;

  case 40:
#line 201 "../../crexx-develop/re2c/src/parse/parser.ypp"
    { (yyval.op) = '?'; ;}
    break;

  case 42:
#line 206 "../../crexx-develop/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 43:
#line 219 "../../crexx-develop/re2c/src/parse/parser.ypp"
    { (yyval.regexp) = ast_cap((yyvsp[(2) - (3)].regexp)); ;}
    break;


/* Line 1267 of yacc.c.  */
#line 1645 "src/parse/parser.cc"
      default: break;
    }
...
#line 222 "../../crexx-develop/re2c/src/parse/parser.ypp"
