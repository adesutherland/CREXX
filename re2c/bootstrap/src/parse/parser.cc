...
#line 1 "../../crexx-f0051/re2c/src/parse/parser.ypp"
...
yyreduce:
  ...
  switch (yyn)
    {
        case 3:
#line 68 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 4:
#line 72 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 8:
#line 81 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 9:
#line 90 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    {
    context.input.msg.error(context.input.tok_loc()
...
;}
  ...
  case 10:
#line 97 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    { (yyval.str) = (yyvsp[(1) - (2)].str); ;}
    break;

  case 14:
#line 104 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 15:
#line 107 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 16:
#line 110 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 17:
#line 113 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 18:
#line 119 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    {
    for(CondList::const_iterator i = (yyvsp[(1) - (3)].clist)->begin(); i != (yyvsp[(1) - (3)].clist)->end(); ++i) {
...
;}
  ...
  case 19:
#line 125 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    {
    for(CondList::const_iterator i = (yyvsp[(1) - (3)].clist)->begin(); i != (yyvsp[(1) - (3)].clist)->end(); ++i) {
...
;}
  ...
  case 20:
#line 131 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 21:
#line 137 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 23:
#line 145 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 24:
#line 150 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 25:
#line 157 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    { (yyval.regexp) = ast_cap((yyvsp[(1) - (1)].regexp)); ;}
    break;

  case 26:
#line 158 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 28:
#line 165 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    { (yyval.regexp) = ast_alt((yyvsp[(1) - (3)].regexp), (yyvsp[(3) - (3)].regexp)); ;}
    break;

  case 30:
#line 170 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    { (yyval.regexp) = ast_diff((yyvsp[(1) - (3)].regexp), (yyvsp[(3) - (3)].regexp)); ;}
    break;

  case 32:
#line 176 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    { (yyval.regexp) = ast_cat((yyvsp[(1) - (2)].regexp), (yyvsp[(2) - (2)].regexp)); ;}
    break;

  case 34:
#line 181 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    {
    switch((yyvsp[(2) - (2)].op)) {
...
;}
  ...
  case 35:
#line 188 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 37:
#line 195 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    { (yyval.op) = ((yyvsp[(1) - (2)].op) == (yyvsp[(2) - (2)].op)) ? (yyvsp[(1) - (2)].op) : '*'; ;}
    break;

  case 38:
#line 199 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    { (yyval.op) = '*'; ;}
    break;

  case 39:
#line 200 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    { (yyval.op) = '+'; ;}
    break;

  case 40:
#line 201 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    { (yyval.op) = '?'; ;}
    break;

  case 42:
#line 206 "../../crexx-f0051/re2c/src/parse/parser.ypp"
    {
...
;}
  ...
  case 43:
#line 219 "../../crexx-f0051/re2c/src/parse/parser.ypp"
...
#line 222 "../../crexx-f0051/re2c/src/parse/parser.ypp"
