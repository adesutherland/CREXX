...
function(add_rxpa_provider_package plugin_name)
    cmake_parse_arguments(RXPA_PROVIDER "" "OUTPUT_DIRECTORY;PROVIDER_ID;ENGINE_ID"
        "LINK_TARGETS;RUNTIME_TARGETS;BACKEND_TARGETS;RUNTIME_FILES;RUNTIME_SEARCH_DIRECTORIES" ${ARGN})
    ...
    if(RXPA_PROVIDER_LINK_TARGETS OR RXPA_PROVIDER_RUNTIME_TARGETS)
        ...
        endforeach()
        foreach(_directory IN LISTS RXPA_PROVIDER_RUNTIME_SEARCH_DIRECTORIES)
            string(APPEND _package_content "list(APPEND runtime_search_directories \"${_directory}\")\n")
        endforeach()
