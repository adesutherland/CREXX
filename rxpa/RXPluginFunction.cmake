...
function(configure_linker_for_decl_lib target staticLib)
    if(MSVC)
        ...
        set_target_properties(${target} PROPERTIES LINK_FLAGS "/INCLUDE:rx${staticLib}_decl")
    elseif(CMAKE_COMPILER_IS_GNUCC OR CMAKE_COMPILER_IS_GNUCXX)
        # For GCC
        target_link_libraries(${target} -Wl,--whole-archive rx${staticLib}_decl -Wl,--no-whole-archive)
