...
void init_ops() {
    ...
    instr_f("say", "Say op1 (Deprecated)", OP_INT, OP_NONE, OP_NONE);
    instr_f("say", "Say op1 (Deprecated)", OP_FLOAT, OP_NONE, OP_NONE);
    instr_f("say", "Say op1 (Deprecated)", OP_STRING, OP_NONE, OP_NONE);
    instr_f("say", "Say op1 (Deprecated)", OP_CHAR, OP_NONE, OP_NONE);
