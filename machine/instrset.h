...
// ----- amap Instruction Map op1 to arg register index in op2 -----
instruction = src_inst("amap", OP_REG,OP_REG,OP_NONE);
if (instruction) address_map[instruction->opcode] = &&AMAP_REG_REG;
    else print_debug("Instruction AMAP_REG_REG not found\n");
  
// ----- amap Instruction Map op1 to arg register index  op2 -----
instruction = src_inst("amap", OP_REG,OP_INT,OP_NONE);
if (instruction) address_map[instruction->opcode] = &&AMAP_REG_INT;
    else print_debug("Instruction AMAP_REG_INT not found\n");
