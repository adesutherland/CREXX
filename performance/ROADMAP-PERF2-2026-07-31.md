# cREXX PERF2 performance programme — closed roadmap

Closed: 2026-07-31

Status: closed as the complete historical register for PERF2. Adrian declared
the programme complete on 2026-07-31. Completed, rejected, deferred and open
entries below retain their exact closing dispositions; unresolved questions
are transferred explicitly to the successor [`ROADMAP.md`](ROADMAP.md) rather
than being silently marked complete or discarded.
...
This file is the closed PERF2 control plane. Do not rewrite its findings or
statuses to reflect later PERF3 work.
