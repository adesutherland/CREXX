...
| `performance/PERF3-11-WORKLIST.md` | Active scalable RXAS graph/signal/component-SSA programme; M01 XTOY, M02 equivalent constants and M03 repeated absence are complete, with M04 exact self-copy next; also owns the future-capability ledger |
| `performance/PERF3-11-MIGRATION-WORKLIST.md` | Locked remaining-proof inventory and resumable one-authority migration ledger; M01-M03 are complete and M04 is next |
