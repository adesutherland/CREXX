...
|---|---:|---:|
| setup swaps | 2447993 | 0.599552 |
| normal restoration swaps | 2447993 | 0.599552 |
| defensive argument copies | 0 | 0.000000 |
| unclassified swaps | 191800 | n/a |
...
- NR-06 call-window work should use the path and exact-arity distributions above, together with 2447993 setup and 2447993 restoration swaps (1.199104 combined per instruction call across this portfolio run).
- Frame recycling supplied 4082939 of 4083048 observed bytecode activations; preserve the per-workload rows before generalising from the aggregate.
- NR-12 should distinguish 0 attributable argument-copy instructions from the unclassified copy population, and should treat 169277 measured non-local RET_REG copies separately from 3793262 local moves.
