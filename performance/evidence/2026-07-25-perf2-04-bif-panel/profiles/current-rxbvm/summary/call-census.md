...
|---|---:|---:|
| setup swaps | 21977553 | 1.633264 |
| normal restoration swaps | 21977553 | 1.633264 |
| defensive argument copies | 109200 | 0.008115 |
| unclassified swaps | 240800 | n/a |
...
- NR-06 call-window work should use the path and exact-arity distributions above, together with 21977553 setup and 21977553 restoration swaps (3.266527 combined per instruction call across this portfolio run).
- Frame recycling supplied 13455929 of 13456241 observed bytecode activations; preserve the per-workload rows before generalising from the aggregate.
- NR-12 should distinguish 109200 attributable argument-copy instructions from the unclassified copy population, and should treat 4698277 measured non-local RET_REG copies separately from 5327143 local moves.
