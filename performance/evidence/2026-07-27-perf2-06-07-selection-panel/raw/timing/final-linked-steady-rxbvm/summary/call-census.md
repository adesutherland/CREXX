...
|---|---:|---:|
| setup swaps | 2470393 | 0.453617 |
| normal restoration swaps | 2470393 | 0.453617 |
...
- NR-06 call-window work should use the path and exact-arity distributions above, together with 2470393 setup and 2470393 restoration swaps (0.907234 combined per instruction call across this portfolio run).
- Frame recycling supplied 5445874 of 5445999 observed bytecode activations; preserve the per-workload rows before generalising from the aggregate.
- NR-12 should distinguish 0 attributable argument-copy instructions from the unclassified copy population, and should treat 240627 measured non-local RET_REG copies separately from 3626811 local moves.
