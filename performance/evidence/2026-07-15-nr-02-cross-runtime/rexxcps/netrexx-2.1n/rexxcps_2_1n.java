/* Generated from 'rexxcps_2_1n.nrx' 15 Jul 2026 16:20:45 [v5.10] *//* Options: Annotations Decimal Implicituses Java Logo Trace2 Verbose3 */
...
netrexx.lang.RexxIO.Say((((netrexx.lang.Rexx.toRexx("          Averaging:").OpCcblank($1,averaging)).OpCcblank($1,netrexx.lang.Rexx.toRexx("measures of"))).OpCcblank($1,count)).OpCcblank($1,$06));
...
netrexx.lang.RexxIO.Say((((((netrexx.lang.Rexx.toRexx("Total (full DO):").OpCcblank($1,((ffull.OpSub($1,fempty))).OpDiv($1,$029))).OpCcblank($1,netrexx.lang.Rexx.toRexx("secs (average of"))).OpCcblank($1,averaging)).OpCcblank($1,netrexx.lang.Rexx.toRexx("measures of"))).OpCcblank($1,count)).OpCcblank($1,netrexx.lang.Rexx.toRexx("iterations)")));

netrexx.lang.RexxIO.Say((netrexx.lang.Rexx.toRexx("Time for one iteration (1000 clauses) was:").OpCcblank($1,looptime)).OpCcblank($1,$030));
}


cps=($031.OpDiv($1,looptime).OpAdd($1,$032));
...
netrexx.lang.RexxIO.Say((netrexx.lang.Rexx.toRexx("                (").OpCcblank($1,cps.format((netrexx.lang.Rexx)null,new netrexx.lang.Rexx((byte)3),(netrexx.lang.Rexx)null,new netrexx.lang.Rexx((byte)0),new netrexx.lang.Rexx('e')))).OpCcblank($1,$033));
netrexx.lang.RexxIO.Say("");
...
{netrexx.lang.Rexx $14[]=new netrexx.lang.Rexx[5];netrexx.lang.RexxParse.parse(arg1.upper(),$034,$14);a1=$14[0];a2=$14[1];a3=$14[2];a4=$14[4];}
{netrexx.lang.Rexx $15[]=new netrexx.lang.Rexx[4];netrexx.lang.RexxParse.parse(a3,$035,$15);b1=$15[0];b2=$15[1];b3=$15[2];}

{int $16=$036.OpPlus($1).toint();for(;$16>0;$16--){rc=(a1.OpCcblank($1,a2)).OpCcblank($1,a3);{netrexx.lang.Rexx $17[]=new netrexx.lang.Rexx[3];netrexx.lang.RexxParse.parse(rc,$037,$17);c1=$17[0];c2=$17[1];c3=$17[2];}}}
b1=b1;b2=b2;b3=b3;
...
return raw;}private rexxcps_2_1n(){return;}}