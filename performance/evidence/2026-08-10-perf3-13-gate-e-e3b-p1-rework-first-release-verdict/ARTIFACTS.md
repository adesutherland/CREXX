# E3b-P1 inline-rework artifact identity

| Artifact | Bytes | SHA-256 |
| --- | ---: | --- |
| E3a control `rxbvm` | 1,113,112 | `9269ad65cc747a0d4770e0ff79bb2ea87f96769b704585ec616eb899df8cc2ac` |
| inline-rework candidate `rxbvm` | 1,131,096 | `0d2f96c859c3d709b2e11a6dd820aa4b20f641f57a155a08e9e3012b86ff7a84` |
| E3a control `rxtvm` | 1,113,240 | `23a486b17ceaa8685ecb3f3606ddf7748506c7e09c549e2e3ae48d9d130e06fb` |
| inline-rework candidate `rxtvm` | 1,131,256 | `856cacf6467d7d428fec8def1a6394c89dd09e63443bb6697af5e61b249cee8c` |
...
The shared workload/plugin artifacts are byte-identical to the first failed
E3b-P1 verdict. Only the candidate VM call selection changed.

`SOURCE-SHA256SUMS` binds the frozen dirty source and fixtures.
