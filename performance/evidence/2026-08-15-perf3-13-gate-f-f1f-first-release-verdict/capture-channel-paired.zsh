...
"set GF_CONTROL_DIR to the retained F1e Release product directory"}
gf_accepted_image=${GF_ACCEPTED_IMAGE:?
"set GF_ACCEPTED_IMAGE to the legacy-format F1e benchmark image"}
gf_candidate_image=${GF_CANDIDATE_IMAGE:-
"$gf_build_dir/interpreter/test_gate_f_channel_benchmark.rxbin"}
gf_output_dir=${1:?
"usage: capture-channel-paired.zsh OUTPUT_DIR"}
