...
|---|---:|---:|
| setup swaps | 37874 | 0.151809 |
| normal restoration swaps | 37874 | 0.151809 |
...
- NR-06 call-window work should use the path and exact-arity distributions above, together with 37874 setup and 37874 restoration swaps (0.303617 combined per instruction call across this portfolio run).
- Frame recycling supplied 249441 of 249487 observed bytecode activations; preserve the per-workload rows before generalising from the aggregate.
