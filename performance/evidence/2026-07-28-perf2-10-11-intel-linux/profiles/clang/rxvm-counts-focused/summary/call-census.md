...
|---|---:|---:|
| setup swaps | 2368119 | 0.421534 |
| normal restoration swaps | 2368119 | 0.421534 |
| defensive argument copies | 0 | 0.000000 |
| unclassified swaps | 0 | n/a |
| unclassified copies | 1994086 | n/a |
...
|---|---:|
| void | 1884741 |
| RET_REG local move | 3246532 |
| RET_REG non-local copy | 486587 |
| ignored value | 0 |
| immediate | 2 |
...
- NR-06 call-window work should use the path and exact-arity distributions above, together with 2368119 setup and 2368119 restoration swaps (0.843068 combined per instruction call across this portfolio run).
- Frame recycling supplied 5617756 of 5617874 observed bytecode activations; preserve the per-workload rows before generalising from the aggregate.
- NR-12 should distinguish 0 attributable argument-copy instructions from the unclassified copy population, and should treat 486587 measured non-local RET_REG copies separately from 3246532 local moves.
