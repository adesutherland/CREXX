...
|---|---:|---:|
| setup swaps | 37874 | 0.149295 |
| normal restoration swaps | 37874 | 0.149295 |
| defensive argument copies | 0 | 0.000000 |
| unclassified swaps | 50400 | n/a |
| unclassified copies | 2532 | n/a |
...
- NR-06 call-window work should use the path and exact-arity distributions above, together with 37874 setup and 37874 restoration swaps (0.298591 combined per instruction call across this portfolio run).
- Frame recycling supplied 253641 of 253687 observed bytecode activations; preserve the per-workload rows before generalising from the aggregate.
- NR-12 should distinguish 0 attributable argument-copy instructions from the unclassified copy population, and should treat 0 measured non-local RET_REG copies separately from 190049 local moves.
