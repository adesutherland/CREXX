...
Retained 2 exact-image entries, 272 ranked instruction rows, 276 procedure-metric rows, 18 allocation rows, and 3233 RXSEQ candidate rows.

| Pair | Baseline median ns | Candidate median ns | Delta ns | Delta % |
|---|---:|---:|---:|---:|
| rexxcps | 1062109000 | 1074959000 | 12850000 | 1.210 |
