...
|---|---:|---:|
| setup swaps | 21907553 | 1.711579 |
| normal restoration swaps | 21907553 | 1.711579 |
| defensive argument copies | 109200 | 0.008532 |
| unclassified swaps | 37800 | n/a |
...
- NR-06 call-window work should use the path and exact-arity distributions above, together with 21907553 setup and 21907553 restoration swaps (3.423157 combined per instruction call across this portfolio run).
- Frame recycling supplied 12799330 of 12799640 observed bytecode activations; preserve the per-workload rows before generalising from the aggregate.
- NR-12 should distinguish 109200 attributable argument-copy instructions from the unclassified copy population, and should treat 4769577 measured non-local RET_REG copies separately from 4658042 local moves.
