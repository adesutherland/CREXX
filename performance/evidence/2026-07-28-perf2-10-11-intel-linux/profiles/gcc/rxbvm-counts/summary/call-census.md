...
|---|---:|---:|
| setup swaps | 21913153 | 1.707534 |
| normal restoration swaps | 21913153 | 1.707534 |
| defensive argument copies | 109200 | 0.008509 |
| unclassified swaps | 46200 | n/a |
| unclassified copies | 11456216 | n/a |
...
- NR-06 call-window work should use the path and exact-arity distributions above, together with 21913153 setup and 21913153 restoration swaps (3.415068 combined per instruction call across this portfolio run).
- Frame recycling supplied 12832930 of 12833240 observed bytecode activations; preserve the per-workload rows before generalising from the aggregate.
- NR-12 should distinguish 109200 attributable argument-copy instructions from the unclassified copy population, and should treat 4769577 measured non-local RET_REG copies separately from 4688842 local moves.
