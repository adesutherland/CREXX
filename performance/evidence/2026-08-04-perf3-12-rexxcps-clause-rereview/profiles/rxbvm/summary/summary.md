...
Retained 2 exact-image entries, 262 ranked instruction rows, 264 procedure-metric rows, 18 allocation rows, and 3075 RXSEQ candidate rows.

| Pair | Baseline median ns | Candidate median ns | Delta ns | Delta % |
|---|---:|---:|---:|---:|
| rexxcps-current | 2895206000 | 1780542000 | -1114664000 | -38.500 |
