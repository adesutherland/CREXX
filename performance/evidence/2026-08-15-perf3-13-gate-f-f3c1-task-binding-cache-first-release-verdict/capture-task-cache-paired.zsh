...
"set GF_CONTROL_DIR to the retained pre-cache F1f Release product directory"}
gf_accepted_image=${GF_ACCEPTED_IMAGE:?
"set GF_ACCEPTED_IMAGE to the sealed F1f benchmark image"}
gf_candidate_image=${GF_CANDIDATE_IMAGE:-
"$gf_build_dir/interpreter/test_gate_f_channel_benchmark.rxbin"}
gf_output_dir=${1:?
"usage: capture-task-cache-paired.zsh OUTPUT_DIR"}
