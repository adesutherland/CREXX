...
Retained 2 exact-image entries, 140 ranked instruction rows, 60 procedure-metric rows, 18 allocation rows, and 0 RXSEQ candidate rows.

| Pair | Baseline median ns | Candidate median ns | Delta ns | Delta % |
|---|---:|---:|---:|---:|
| JSON-stripped-A-prime | 343494000 | 335704000 | -7790000 | -2.268 |
