...
|---|---:|---:|
| setup swaps | 0 | n/a |
| normal restoration swaps | 0 | n/a |
| defensive argument copies | 0 | n/a |
| unclassified swaps | 0 | n/a |
| unclassified copies | 0 | n/a |
...
- NR-06 call-window work should use the path and exact-arity distributions above, together with 0 setup and 0 restoration swaps (n/a combined per instruction call across this portfolio run).
- Frame recycling supplied 0 of 4 observed bytecode activations; preserve the per-workload rows before generalising from the aggregate.
- NR-12 should distinguish 0 attributable argument-copy instructions from the unclassified copy population, and should treat 0 measured non-local RET_REG copies separately from 0 local moves.
