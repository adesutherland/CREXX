...
| PERF3-12B | P1 | Compound-tail representation and loop-scoped reuse | in progress — B3 H1 PoC complete; B4 awaiting approval | S1 removes 1.68M net dispatches after stable-left setup. H1 proves lazy reuse at all four later sites and removes 1.96M with no setup dispatch; preheader placement correctly fails must-execute/invariance/TRACE gates. Both isolated routes retain `.locals=104`, full focused/native-stem and six-cell dual-VM correctness are green, and H1 leaves first-epoch SSA bytes unchanged. The battery-host elapsed sample is non-authoritative; B4 is the AC balanced Release comparison and route-selection stop. Control: [`PERF3-12B-WORKLIST.md`](PERF3-12B-WORKLIST.md); evidence: [`B2 S1 PoC`](evidence/2026-08-04-perf3-12b-b2-s1-poc/), [`B3 H1 PoC`](evidence/2026-08-04-perf3-12b-b3-h1-poc/). |
...
Evidence:
[`B3 H1 PoC`](evidence/2026-08-04-perf3-12b-b3-h1-poc/). B4 is the AC
balanced/interleaved S0/S1/H1 Release comparison and route-selection stop;
S1 and H1 remain unlayered.
