...
| PERF3-12B | P1 | Compound-tail representation and loop-scoped reuse | in progress — B2 S1 PoC complete; B3 awaiting approval | S1 proves four of five generated sites, removes 1.96M CONCAT dispatches at a 0.28M stable-left LOAD cost, and correctly rejects the fifth signal-skip/TRACE case. Focused/native-stem and six dual-VM smoke cells are green; matched assembler scale is neutral. H1 remains untouched. Control: [`PERF3-12B-WORKLIST.md`](PERF3-12B-WORKLIST.md); evidence: [`B2 S1 PoC`](evidence/2026-08-04-perf3-12b-b2-s1-poc/). |
...
[`B2 S1 PoC`](evidence/2026-08-04-perf3-12b-b2-s1-poc/). B3 is the separately
replayable H1 loop-scoped reuse PoC and awaits approval; S1 and H1 remain
unlayered.
