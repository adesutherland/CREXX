...
| PERF3-13 / CAP-06 | P0 | RXVM allocator, value-shape and worker-communication foundation | Gate E E3a accepted and Mac closeout complete; E3b-P1 A/C compatibility slice approved; Gate F closed | Gate C selected the 176-byte L32SDH value and Gate D industrialised the worker slab architecture. EF-0 is published in `642e1b697`; E1/E1-P1 and their Windows-MinGW corrections are published through `84d406904`, with all 1,999 Windows tests green. E2 removes ambient RXVML/RXPA/SAY/CREXX/reference/interrupt state, gives each VM a logical directory/environment and one direct execution-local interrupt word, and leaves Gate F propagation closed. Adrian accepted its first verdict: Sieve is neutral at -0.012799%; RexxCPS is clearly adverse at -1.206404% but inside the 3% guard. Mac closeout passes Debug 1,999/1,999, full AddressSanitizer 1,999/1,999 and focused Release 49/49. The sanitizer sweep also exposed and repaired an independent RXAS sparse-batch snapshot UAF using stable record IDs and re-pinning after inline-array growth, with no per-record malloc and neutral direct assembly timing. Apple LSan is unsupported; native E2 Windows/MSVC/Linux proof remains ordered follow-up. Current clean `6d12cd921` uses the selected profile-20 handler panel (120/589 policy-controlled non-reserved definitions inline). Its fresh both-engine seven-workload absolute baseline passes 168/168 initial plus 40/40 governed-append processes; Base64 remains noise-labelled and the observation is not an unmatched regression claim. Adrian approved E3a on 2026-08-10 through its first frozen ordinary-Release verdict; it moves RXVM provider/decimal instances to worker-VM ownership. The frozen verdict passes 208/208 processes, all eight product/guard comparisons are statistically inconclusive, no 3% adverse guard fires, and product `rxbvm` paired medians range from -0.069720% to +0.962402%. Adrian accepted E3a on 2026-08-10 and directed the programme to E3b. The shortest Mac closeout passes focused Debug 15/15, Release ownership 1/1 and full Debug 2,007/2,007; rebuilt Release VMs are byte-identical to the verdict artifacts. Adrian approved the backward-compatible E3b A/C model: unmodified plugins use a recursive serialized compatibility lane, while an audited plugin may add a versioned `RXPA_PLUGIN_PROCESS_REENTRANT` assertion and bypass that lane. Static replay and DSO lifetime become explicit in P1; session factories/default sessions and call flags remain a gated P2. Public workers, channels and RXAS/RXBIN changes remain closed. The later Gate F value remains a logical scalar/binary register image with ordered child-register images, never an internal `value *`. Control: [`PERF3-13-WORKLIST.md`](PERF3-13-WORKLIST.md); baseline: [`2026-08-10-perf3-13-e3-current-baseline`](evidence/2026-08-10-perf3-13-e3-current-baseline/); E3a verdict: [`2026-08-10-perf3-13-gate-e-e3a-first-release-verdict`](evidence/2026-08-10-perf3-13-gate-e-e3a-first-release-verdict/); E2: [`2026-08-08-perf3-13-gate-e-e2-active-state`](evidence/2026-08-08-perf3-13-gate-e-e2-active-state/); E1-P1: [`2026-08-07-perf3-13-gate-e-e1-p1-wrapper`](evidence/2026-08-07-perf3-13-gate-e-e1-p1-wrapper/); E1: [`2026-08-07-perf3-13-gate-e-e1-worker-shell`](evidence/2026-08-07-perf3-13-gate-e-e1-worker-shell/); EF-0: [`2026-08-07-perf3-13-ef0-spawn-recovery`](evidence/2026-08-07-perf3-13-ef0-spawn-recovery/); Gate D: [`2026-08-07-perf3-13-gate-d-local-closeout`](evidence/2026-08-07-perf3-13-gate-d-local-closeout/); Gate C: [`2026-08-06-perf3-13-gate-c-m3-sidecar-decision`](evidence/2026-08-06-perf3-13-gate-c-m3-sidecar-decision/); Gate B: [`2026-08-06-perf3-13-gate-b-closeout`](evidence/2026-08-06-perf3-13-gate-b-closeout/). |
