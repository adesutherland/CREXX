...
complete on Mac. Linux, Windows and clean-runner ODBC proof, E4, public
workers/channels and Gate F remain closed pending publication or a separate
approval.
...
| PERF3-13 / CAP-06 | P0 | RXVM allocator, value-shape and worker-communication foundation | Gate E E3 complete on Mac; portable proof, E4 and Gate F closed | Gate C selected the 176-byte L32SDH value; Gate D industrialised worker slabs; EF-0, E1 and E1-P1 established the worker ownership shell. E2 removes ambient RXVML/RXPA/SAY/CREXX/reference/interrupt state and passes Mac Debug/ASan/Release closeout. E3a moves provider/decimal instances to VM ownership. E3b-P1 preserves the initializer/call ABI, adds audited plugin-wide process-reentrant opt-in, synchronized static replay, VM-owned DSO lifetime, serialized legacy payload callbacks and a branch-free load-bound invoker. Its accepted 312-process verdict and Mac closeout are guard-clean. E3b-P2 adds a separate optional V2 procedure query and nested-safe per-VM sessions without changing `_initfuncs`, `rxpa_libfunc`, `ADDPROC`, RXAS or RXBIN. Five representative bundled plugins are process-reentrant, `rxmath` proves mixed policy and ODBC proves isolated ENV/DBC/STMT/transaction/diagnostic ownership plus opaque prepared statements and old-host default-session compatibility. The accepted 156-process P2 verdict has no direct-path regression; empty session calls add 2.92-4.08 ns, lifecycle is neutral and VM files grow 432 bytes. Initial full Debug passes 2,032/2,032; focused Debug, Apple ASan and Release panels are green, with verdict VM hashes unchanged. After approved installation, a six-test ODBC panel passes in all three configurations; real unixODBC/SQLite runtimes cover both VMs while the mock retains concurrency, failure, teardown and old-host proof. The final ODBC-enabled full Debug suite passes 2,034/2,034. Linux, Windows and clean-runner driver proof remains a publication follow-up. E4, public workers/channels and Gate F require separate approval. The later Gate F value remains a logical scalar/binary register image with ordered child-register images, never an internal `value *`. Control: [`PERF3-13-WORKLIST.md`](PERF3-13-WORKLIST.md); P2 verdict: [`session-aware verdict`](evidence/2026-08-10-perf3-13-gate-e-e3b-p2-first-release-verdict/); bundled qualification: [`plugin verdict`](evidence/2026-08-10-perf3-13-gate-e-e3b-bundled-plugin-first-release-verdict/); accepted E3b-P1 verdict: [`branch-free production verdict`](evidence/2026-08-10-perf3-13-gate-e-e3b-p1-branch-free-first-release-verdict/); isolated ceiling: [`branch-free invoker PoC`](evidence/2026-08-10-perf3-13-gate-e-e3b-p1-branch-free-invoker-poc/); rejected candidates: [`out-of-line wrapper`](evidence/2026-08-10-perf3-13-gate-e-e3b-p1-first-release-verdict/), [`inline branch`](evidence/2026-08-10-perf3-13-gate-e-e3b-p1-rework-first-release-verdict/); E3a verdict: [`2026-08-10-perf3-13-gate-e-e3a-first-release-verdict`](evidence/2026-08-10-perf3-13-gate-e-e3a-first-release-verdict/); baseline: [`2026-08-10-perf3-13-e3-current-baseline`](evidence/2026-08-10-perf3-13-e3-current-baseline/). |
