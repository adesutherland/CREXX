...
- `CAP-06` is active as PERF3-13. Gate A M0 audited every allocator-eligible
  ...
  and ordinary Release 14/14. E1 is locally complete and awaiting publication;
  E2 requires separate approval. Transport-neutral channel semantics stay
  closed until the worker model is selected. Control:
