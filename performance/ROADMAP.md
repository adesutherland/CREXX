...
| PERF3-04 | P1 | Generic final/concrete scalar accessor proof | transferred post-PERF3 | The lead is preserved in `docs/ROADMAP.md`: a hand-equivalent ceiling and generic compiler proof across the expanded suite must precede any candidate. No JSON-, vector- or numeric-width-specific opcode is implied. |
