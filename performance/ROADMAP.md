...
| PERF3-13 / CAP-06 | P0 | RXVM allocator, value-shape and worker-communication foundation | EF-0 accepted and locally complete; publication pending; full Gates E/F remain closed | Gate C selected L32SDH: retain the hot decimal payload pointer and place raw `size_t` length/capacity immediately before the payload in the same sticky worker-slab allocation. It is 176 bytes versus the frozen 192-byte L32S control. The clean Gate D product contains no research layout selector and preserves the selected artifact shape. Its accepted mandatory first Release verdict was +0.968% pooled. Final Mac Gate D closeout passes focused Debug/Release 15/15, affected ASan 12/12 plus Unicode 1/1, isolated install/product proof and 208/208 fresh governed executions; the two post-correction timing blocks combine to +1.205% over 96 core-four pairs (95% interval +0.748% to +1.663%), with no guard hit. The develop integration preserved the DECIMAL-01 repeated-formatting repair but exposed the known spawn gap: its pre-EF-0 Debug sweep was effectively 1,968/1,990 and the exact 22 survivors returned their expected result before driver/spawn teardown found live allocations. Adrian opened and accepted EF-0 on 2026-08-07 as the first bounded coherent-multithreading slice. Redirect helpers now receive immutable input or independent libc byte completions, never a VM worker or `value *`; join publishes one terminal completion and the receiver worker performs final conversion. The accepted first Release verdict passed focused recovery 15/15, the exact 22 plus fixture 23/23, and ordinary-VM controls 4/4. Post-acceptance closeout passes focused ASan 34/34, full Debug 1,996/1,996 and combined Release 38/38. LeakSanitizer is unsupported by Apple ASan and no Windows cross-toolchain is installed; Debug teardown remains exact and native Windows compile/run proof is outstanding. The preferred later Gate F message model is a logical register image with a typed scalar/binary payload and ordered child-register images, never a live internal VM `value`. Full worker execution remains closed until EF-0 is explicitly published; transport-neutral channels remain closed until the worker model is selected. R0 remains selected: no automatic value-sidecar reclamation or pressure check on logical reset; explicit depot trim remains. R1/R2 require a later separately approved Gate D-R. The guard-clean 160-byte decimal/object maximum remains rejected because Towers adds 12,071,103 descriptor allocations (+25.0%) to save only another 44,800 peak bytes. Native sidecars and separate decimal descriptors remain rejected. Base64 remains noisy/non-selecting CAP-03 Level B library/API work. Intel Linux, Linux ARM64 and same-machine Windows rebuild-together validation remain before global Gate D closure. Control: [`PERF3-13-WORKLIST.md`](PERF3-13-WORKLIST.md); EF-0: [`2026-08-07-perf3-13-ef0-spawn-recovery`](evidence/2026-08-07-perf3-13-ef0-spawn-recovery/); local closeout: [`2026-08-07-perf3-13-gate-d-local-closeout`](evidence/2026-08-07-perf3-13-gate-d-local-closeout/); Gate D first verdict: [`2026-08-07-perf3-13-gate-d-first-release-verdict`](evidence/2026-08-07-perf3-13-gate-d-first-release-verdict/); M3 decision: [`2026-08-06-perf3-13-gate-c-m3-sidecar-decision`](evidence/2026-08-06-perf3-13-gate-c-m3-sidecar-decision/); V1 first verdict: [`2026-08-06-perf3-13-gate-c-v1-first-release-verdict`](evidence/2026-08-06-perf3-13-gate-c-v1-first-release-verdict/); C2: [`2026-08-06-perf3-13-gate-c-c2-geometry-formal-verdict`](evidence/2026-08-06-perf3-13-gate-c-c2-geometry-formal-verdict/); C1: [`2026-08-06-perf3-13-gate-c-c1-census`](evidence/2026-08-06-perf3-13-gate-c-c1-census/); Gate B: [`2026-08-06-perf3-13-gate-b-closeout`](evidence/2026-08-06-perf3-13-gate-b-closeout/). |
...
- `CAP-06` is active as PERF3-13. Gate A M0 audited every allocator-eligible
  ...
  remain mandatory proofs. Full worker execution stays closed until Adrian
  approves EF-0 publication; transport-neutral channel semantics stay closed
  until the worker model is selected. Control:
  [`PERF3-13-WORKLIST.md`](PERF3-13-WORKLIST.md); EF-0 evidence:
