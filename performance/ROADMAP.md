...
| PERF3-13 / CAP-06 | P0 | RXVM allocator, value-shape and worker-communication foundation | Gate E E6 C0 accepted and Mac QA closed; Gate F F0-S through F1g-D implementation and Mac QA complete; portable publication evidence pending | Gate E selects strict owner-local VM state and private portable workers. Gate F fixes execution-local globals, single-owner mutable services, receiver-materialized `ChannelValue`, structured scopes and the mandatory five-operation RXAS bridge. F1a-F1f deliver the both-VM opcodes, complete local/process providers and Level B surface, reusable byte endpoints, structured child processes/ADDRESS migration, and the Level G-gated task/parallel surface with sealed task procedure, transferable receiver and `.taskwork` factory bindings. F3C1 recovers repeated sealed-binding validation with a bounded worker-local cache while preserving first-miss validation and public contracts; its seven-workload full baseline is guard-clean. F1g-A adds codec-backed concrete-class task results and imported task/link fidelity. F1g-B adds bounded admission and reusable single-owner HTTP connections. F1g-C adds safe headers, policy/budgets, verified TLS, redirect/retry rules, ambiguity and bounded failure handling. F1g-D completes bounded streaming, gzip/deflate decoding, typed task arguments and the concurrent crexx-rag fixture without a new opcode/provider. Control: [`PERF3-13-WORKLIST.md`](PERF3-13-WORKLIST.md); [user guide](PERF3-13-GATE-F-USER-GUIDE.md); [AI specification](PERF3-13-GATE-F-AI-SPEC.md); [implementation plan](PERF3-13-GATE-F-IMPLEMENTATION-PLAN.md); [F1a/F1b evidence](evidence/2026-08-14-perf3-13-gate-f-f1ab-first-release-verdict/); [F1c evidence](evidence/2026-08-14-perf3-13-gate-f-f1c-first-release-verdict/); [F1d evidence](evidence/2026-08-15-perf3-13-gate-f-f1d-first-release-verdict/); [F1e evidence](evidence/2026-08-15-perf3-13-gate-f-f1e-first-release-verdict/); [F1f evidence](evidence/2026-08-15-perf3-13-gate-f-f1f-first-release-verdict/); [F3C1 evidence](evidence/2026-08-15-perf3-13-gate-f-f3c1-task-binding-cache-first-release-verdict/); [F3C1 full baseline](evidence/2026-08-15-perf3-13-f3c1-full-baseline/); [F1g-A evidence](evidence/2026-08-15-perf3-13-gate-f-f1g-a-typed-task-results-first-release-verdict/); [F1g-B evidence](evidence/2026-08-15-perf3-13-gate-f-f1g-b-pooled-http-owner-first-release-verdict/); [F1g-C evidence](evidence/2026-08-15-perf3-13-gate-f-f1g-c-http-policy-first-release-verdict/); [F1g-D evidence](evidence/2026-08-15-perf3-13-gate-f-f1g-d-streaming-integration-first-release-verdict/); [Gate F design](PERF3-13-GATE-F-DESIGN.md). |
