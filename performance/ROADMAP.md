...
procedure, transferable receiver and `.taskwork` factory bindings. Its
confirmed tiny-task latency cost is retained for F3/release hardening under
Adrian's standing continuation direction; throughput is inconclusive. F1g
concurrent HTTP/TLS is next. Evidence:
...
| PERF3-13 / CAP-06 | P0 | RXVM allocator, value-shape and worker-communication foundation | Gate E E6 C0 accepted and Mac QA closed; Gate F F0-S through F1f complete; F1g next | Gate E selects strict owner-local VM state and private portable workers. Gate F fixes execution-local globals, single-owner mutable services, receiver-materialized `ChannelValue`, structured scopes and the mandatory five-operation RXAS bridge. F1a-F1f now deliver the both-VM opcodes, complete local/process providers and Level B surface, reusable byte endpoints, structured child processes/ADDRESS migration, and the Level G-gated task/parallel surface with sealed task procedure, transferable receiver and `.taskwork` factory bindings. F1f's confirmed tiny-task latency cost is retained for F3/release hardening under Adrian's standing continuation direction; throughput is inconclusive. F1g concurrent HTTP/TLS is next. Control: [`PERF3-13-WORKLIST.md`](PERF3-13-WORKLIST.md); [user guide](PERF3-13-GATE-F-USER-GUIDE.md); [AI specification](PERF3-13-GATE-F-AI-SPEC.md); [implementation plan](PERF3-13-GATE-F-IMPLEMENTATION-PLAN.md); [F1a/F1b evidence](evidence/2026-08-14-perf3-13-gate-f-f1ab-first-release-verdict/); [F1c evidence](evidence/2026-08-14-perf3-13-gate-f-f1c-first-release-verdict/); [F1d evidence](evidence/2026-08-15-perf3-13-gate-f-f1d-first-release-verdict/); [F1e evidence](evidence/2026-08-15-perf3-13-gate-f-f1e-first-release-verdict/); [F1f evidence](evidence/2026-08-15-perf3-13-gate-f-f1f-first-release-verdict/); [Gate F design](PERF3-13-GATE-F-DESIGN.md). |
