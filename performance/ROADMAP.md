...
the verdict artifacts. E3b-P1 is accepted for local commit; P2 sessions,
cross-platform proof, public workers/channels and Gate F remain closed.
...
| PERF3-13 / CAP-06 | P0 | RXVM allocator, value-shape and worker-communication foundation | Gate E E3a and E3b-P1 accepted; E3b-P1 Mac closeout complete; P2 and Gate F closed | Gate C selected the 176-byte L32SDH value; Gate D industrialised worker slabs; EF-0, E1 and E1-P1 established the worker ownership shell. E2 removes ambient RXVML/RXPA/SAY/CREXX/reference/interrupt state and passes Mac Debug/ASan/Release closeout. The profile-20 baseline remains current. E3a moves provider/decimal instances to VM ownership and passes an accepted neutral 208-process verdict plus Debug 2,007/2,007. E3b-P1 preserves the plugin ABI, adds audited `RXPA_PLUGIN_PROCESS_REENTRANT` opt-in, synchronized static replay, VM-owned DSO lifetime, serialized legacy payload callbacks and a branch-free procedure-bound native invoker. The first two integrated call forms were rejected at 14-20% overhead; the selected load-bound form passes 312/312 formal processes and every guard. Product `rxbvm` process-reentrant calls are inconclusive at +1.368096% and legacy calls at +0.104869%; guard `rxtvm` measures +2.175049% reentrant overhead below the 3% guard and an inconclusive -0.413910% legacy result. Sieve, RexxCPS, lifecycle and artifacts are guard-clean. Mac closeout passes Debug 2,017/2,017 and focused Release 11/11; rebuilt VMs are byte-identical to the verdict artifacts. P2 sessions/default sessions/per-call flags, cross-platform proof, public workers/channels and Gate F remain separate gates. The later Gate F value remains a logical scalar/binary register image with ordered child-register images, never an internal `value *`. Control: [`PERF3-13-WORKLIST.md`](PERF3-13-WORKLIST.md); accepted E3b-P1 verdict: [`branch-free production verdict`](evidence/2026-08-10-perf3-13-gate-e-e3b-p1-branch-free-first-release-verdict/); isolated ceiling: [`branch-free invoker PoC`](evidence/2026-08-10-perf3-13-gate-e-e3b-p1-branch-free-invoker-poc/); rejected candidates: [`out-of-line wrapper`](evidence/2026-08-10-perf3-13-gate-e-e3b-p1-first-release-verdict/), [`inline branch`](evidence/2026-08-10-perf3-13-gate-e-e3b-p1-rework-first-release-verdict/); E3a verdict: [`2026-08-10-perf3-13-gate-e-e3a-first-release-verdict`](evidence/2026-08-10-perf3-13-gate-e-e3a-first-release-verdict/); baseline: [`2026-08-10-perf3-13-e3-current-baseline`](evidence/2026-08-10-perf3-13-e3-current-baseline/). |
