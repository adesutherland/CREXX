...
| RCC5-MATH | P1 approved production | Level G mathematics composition and historical provider split | RCC-5A-E and BINARY-01 implemented with verdicts accepted; D/E proportional QA complete; RCC-5F unblocked and next; consolidated end-of-5 QA and supported Linux ASan/LSan pending | The Level G standard family separates process-reentrant native `rxfloat` from Level-B-authored `rxint` and `rxdecimal`. Direct scalar `rxmath` compatibility names share `rxfloat`; the mixed provider is retired. RCC-5D adds an explicitly transitional boxed-array `rxstats` semantic oracle using compensated shifted-origin reductions and second-pass fallback. Its clear-host first-Release verdict is favorable on ordinary and offset work for both VM modes except one noisy/inconclusive offset `rxtvm` cell; no guard hit, and Adrian accepted the rework on 2026-08-21. RCC-5E moves retained checksum/hash, ID, filesystem and platform contracts into `rx_hash`, `rxid`, `rxfs`, and `rxplatform`, and removes draft developer/UI/legacy surfaces rather than preserving aliases. D/E qualification passes full Debug 2,324/2,324, focused Release 37/37, and focused Apple ASan 42/42; the consolidated broad sanitizer and cross-platform gate remains deliberately deferred until the end of RCC-5. RCC-5B's black-box suite covers all 37 float procedures plus compatibility and native arity boundaries; RCC-5C adds exhaustive/boundary integer oracles and independent high-precision decimal vectors, qualifying every decimal export through 128 digits without establishing a runtime ceiling. SAN-001's stable-ID/reacquisition repair and SAN-002's value-aware decimal output sizing have permanent counterfactual regressions and a complete 2,310/2,310 Apple-ASan gate. The supported Linux ASan/LSan gate remains required, so [`SAN-001` and `SAN-002`](../docs/SANITIZER-WORKLIST.md) stay live. The accepted BINARY-01 baseline unblocks RCC-5F to replace boxed statistics arguments with aligned host-native storage and record the later `rxvector` dependency. Control: [`RCC5-MATH-WORKLIST.md`](RCC5-MATH-WORKLIST.md); RCC-5D/E verdict: [`2026-08-21-rcc5de-provider-split-first-release-verdict`](evidence/2026-08-21-rcc5de-provider-split-first-release-verdict/); SAN-001 verdict: [`2026-08-21-san-001-ssa-release-verdict`](evidence/2026-08-21-san-001-ssa-release-verdict/); validation: [`mathematics-validation-strategy.md`](../docs/planning/release-1/mathematics-validation-strategy.md); RCC-5B evidence: [`2026-08-20-rcc5b-rxfloat-first-release-verdict`](evidence/2026-08-20-rcc5b-rxfloat-first-release-verdict/); dynamic-precision evidence: [`2026-08-20-rcc5c-dynamic-precision-first-release-verdict`](evidence/2026-08-20-rcc5c-dynamic-precision-first-release-verdict/); packed prerequisite: [`BINARY-01-WORKLIST.md`](BINARY-01-WORKLIST.md). |
