...
edit. F1a-F1e are now complete: the five RXAS operations execute on both
...
completion. The F1d and F1e paired verdicts have no confirmed regression;
the separately accepted computed-goto code-layout cost remains recorded for
final hot-loop hardening. F1e isolated-process tasks are complete; F1f Level G
lowering is next. Evidence:
...
| PERF3-13 / CAP-06 | P0 | RXVM allocator, value-shape and worker-communication foundation | Gate E E6 C0 accepted and Mac QA closed; Gate F F0-S through F1e complete; F1f next | Gate E selects strict owner-local VM state and private portable workers. Gate F fixes execution-local globals, single-owner mutable services, receiver-materialized `ChannelValue`, structured scopes and the mandatory five-operation RXAS bridge. F1a-F1e now deliver the both-VM opcodes, complete local provider and Level B surface, reusable byte endpoints, structured child processes/ADDRESS migration, and type `2` isolated tasks with bounded warm processes, fresh per-task VMs, preserved multi-graph callable identity and exactly-once crash/cancel/deadline completion. F1d/F1e have no confirmed Release regression; the accepted computed-goto layout cost remains for F3 hardening. F1f Level G lowering is next. Control: [`PERF3-13-WORKLIST.md`](PERF3-13-WORKLIST.md); [user guide](PERF3-13-GATE-F-USER-GUIDE.md); [AI specification](PERF3-13-GATE-F-AI-SPEC.md); [implementation plan](PERF3-13-GATE-F-IMPLEMENTATION-PLAN.md); [F1a/F1b evidence](evidence/2026-08-14-perf3-13-gate-f-f1ab-first-release-verdict/); [F1c evidence](evidence/2026-08-14-perf3-13-gate-f-f1c-first-release-verdict/); [F1d evidence](evidence/2026-08-15-perf3-13-gate-f-f1d-first-release-verdict/); [F1e evidence](evidence/2026-08-15-perf3-13-gate-f-f1e-first-release-verdict/); [Gate F design](PERF3-13-GATE-F-DESIGN.md). |
